...
class NenLandingPageSeeder extends Seeder
{
    ...
    private function seedSettings(): void
    {
        ...
        $landing->update([
            ...
            'hero_subtitle'       => 'Join the ultimate educational network where students, top universities, and world-class programs come together! Get ready to start your academic success.',
            'hero_btn_text'       => 'Find a collection point',
            ...
            'footer_copyright'   => '© ' . date('Y') . ' NEN | National Education Network. All Rights Reserved.',
    ...
    {
        if (NenLandingFeatureCard::query()->count() > 0) {
            return;
        }
        ...
        $cards = [
            [
                ...
                'description' => 'Internationally recognized universities with modern campuses and English-taught programs.',
            ...
            [
                ...
                'description' => 'Students can save up to 50% on tuition and living expenses compared to other countries.',
            ...
            [
                ...
                'description' => 'A safe and welcoming country with a rich cultural heritage for international students.',
            ...
            [
                ...
                'description' => 'Welcoming international student community and a growing number of programs in English.',
        ...
        foreach ($cards as $card) {
            NenLandingFeatureCard::query()->create(array_merge($card, ['is_active' => true]));
        }
    }

    private function seedHowItWorksSteps(): void
    {
        if (NenLandingHowItWorksStep::query()->count() > 0) {
            return;
        }
        ...
        $steps = [
            ...
            [
                ...
                'description' => 'Explore universities and programmes on the portal and select up to 5 universities and programmes.',
                'image'       => $this->base . '/component/component-university.png',
            ],
            [
                'step_number' => 3,
                'title'       => 'Prepare Documents',
                'description' => 'Prepare and submit the required documents through NEN collection points.',
                'image'       => $this->base . '/component/component-files.png',
            ],
            [
                'step_number' => 4,
                'title'       => 'Visit a Collection Point',
                'description' => 'NEN verifies your documents and coordinates with the relevant authorities.',
                'image'       => $this->base . '/component/component-map-pinpoint.png',
            ],
            [
                'step_number' => 5,
                'title'       => 'Verify',
                'description' => 'Receive admission updates and application support.',
                'image'       => $this->base . '/component/component-checkmark.png',
            ],
            [
                'step_number' => 6,
                'title'       => 'Admission Follow-Up',
                'description' => 'Complete your visa application and prepare for your study journey.',
                'image'       => $this->base . '/component/component-folder-view.png',
            ],
        ];

        foreach ($steps as $i => $step) {
            NenLandingHowItWorksStep::query()->create(array_merge($step, [
                'sort_order' => $i,
                'is_active'  => true,
            ]));
        }
