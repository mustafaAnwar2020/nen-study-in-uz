                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ route('admin.products.create') }}" class="btn btn-sm btn-dark mr-2 float-right">
                                    ...
                                    <tbody>
                                        @foreach ($rows as $idx => $row)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('admin.products.edit', $row->slug) }}"
                                                        class="btn btn-dark btn-sm">
                                                        <i class="fas fa-pen"></i>
                                                    </a>
                                                    <form action="{{ route('admin.products.delete', $row->id) }}"
