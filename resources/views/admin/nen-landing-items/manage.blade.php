                    ...
                    <form action="{{ route('admin.nen-landing-items.store', $resource) }}" method="post" id="form">
                        ...
                        @elseif($resource === 'feature-cards')
                            <div class="row">
                                ...
                                <div class="col-md-9"><div class="form-group"><label>Stat Label</label><input class="form-control" name="stat_label" value="{{ $row->stat_label ?? '' }}"></div></div>
                            </div>
                            <div class="form-group"><label>Title <span class="text-danger">*</span></label><input class="form-control" name="title" value="{{ $row->title ?? '' }}" required></div>
                            <div class="form-group"><label>Description</label><textarea class="form-control" name="description" rows="2">{{ $row->description ?? '' }}</textarea></div>
                        ...
                        @elseif($resource === 'how-it-works')
                            <div class="row">
                                ...
                                <div class="col-md-10"><div class="form-group"><label>Title <span class="text-danger">*</span></label><input class="form-control" name="title" value="{{ $row->title ?? '' }}" required></div></div>
                            </div>
                            <div class="form-group"><label>Description</label><textarea class="form-control" name="description" rows="2">{{ $row->description ?? '' }}</textarea></div>
                        ...
                        @elseif($resource === 'translation-agencies')
                            <div class="form-group"><label>Agency Name <span class="text-danger">*</span></label><input class="form-control" name="name" value="{{ $row->name ?? '' }}" required></div>
                            <div class="form-group"><label>Service Description</label><input class="form-control" name="service_description" value="{{ $row->service_description ?? '' }}"></div>
                            <div class="form-group"><label>Logo / Image</label><x-file-upload class="form-control" data-folder="nen-landing" name="image-file" /></div>
                            <div class="row">
                                <div class="col-md-6"><div class="form-group"><label>City / Location</label><input class="form-control" name="location" value="{{ $row->location ?? '' }}"></div></div>
                        ...
                        @elseif($resource === 'documents')
                            <div class="form-group"><label>Document Title <span class="text-danger">*</span></label><input class="form-control" name="title" value="{{ $row->title ?? '' }}" required></div>
                            <div class="form-group"><label>Description / Note</label><textarea class="form-control" name="description" rows="2">{{ $row->description ?? '' }}</textarea></div>
                            <div class="form-group"><label>Icon Image</label><x-file-upload class="form-control" data-folder="nen-landing" name="image-file" /></div>
