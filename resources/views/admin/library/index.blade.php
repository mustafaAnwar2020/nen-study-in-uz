                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{route('admin.library.create')}}" class="btn btn-sm btn-dark mr-2 float-right">
