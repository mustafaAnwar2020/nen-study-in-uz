                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body p-0 table-responsive">
                                <form action="{{route('admin.protected-files.store')}}" method="post" id="form">
                                    @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="directory" class="form-control @error('directory') is-invalid @enderror" 
                                        ...
                                        @foreach($availableDirectories as $path => $label)
                                            <option value="{{$path}}" {{old('directory') == $path ? 'selected' : ''}}>
                                                {{$label}}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="file_path" class="form-control @error('file_path') is-invalid @enderror" 
                                           name="file_path" value="{{old('file_path')}}" readonly required>
                                    @error('file_path')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="form-text text-muted">
                            ...
                            <div class="card-footer clearfix">
                                <button type="submit" form="form" class="btn btn-dark">
                                    <i class="fa fa-save"></i> Create Protected File
                                </button>
