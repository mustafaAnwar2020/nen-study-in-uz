...
@endphp
<div class="offer-share event-share" aria-label="Share this event">
    ...
    <a href="https://t.me/share/url?url={{ $shareUrlEnc }}&text={{ $shareTextEnc }}"
       class="offer-share__btn offer-share__btn--tg"
       target="_blank" rel="noopener noreferrer"
       title="Share on Telegram"
       aria-label="Share on Telegram"><i class="bi bi-telegram" aria-hidden="true"></i></a>
</div>
